...
class BitmapFontTest extends TinyDisplayObject {
  ...
  void onPaint(TinyStage stage, TinyCanvas canvas) {
    ...
    canvas.drawRect(stage, new TinyRect(10.0, 20.0, 200.0, 200.0), new TinyPaint()
      ..color = new TinyColor.argb(0xff, 0xff, 0xaa, 0xaa)
      ..style = TinyPaintStyle.stroke);
    ...
    canvas.drawRect(stage, new TinyRect(100.0, 100.0, 200.0, 200.0), new TinyPaint()
      ..color = new TinyColor.argb(0xff, 0xaa, 0xaa, 0xff)
      ..style = TinyPaintStyle.stroke);
  }
}
